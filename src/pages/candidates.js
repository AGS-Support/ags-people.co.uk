...
const CandidatesPage = ({ data }) => {
  const services = data.allWpCandidate.nodes
  const pageData = data.wpPage.candidatesPage
  const callToAction = pageData.candidatesCallToAction
...
export const query = graphql`
  query CandidatesPageQuery {
    ...
    wpPage(tags: { nodes: { elemMatch: { slug: { eq: "candidates" } } } }) {
      seo {
        metaDesc
        metaKeywords
        title
