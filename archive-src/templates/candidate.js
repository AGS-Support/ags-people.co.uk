...
const Candidate = ({ data }) => {
  const service = data.wpCandidate.services
  const seo = data.wpCandidate.seo
...
export const query = graphql`
  query CandidateById(
    ...
    previous: wpCandidate(id: { eq: $previousPostId }) {
      uri
      title
    }
    next: wpCandidate(id: { eq: $nextPostId }) {
      uri
      title
    }
  }
